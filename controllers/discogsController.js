...
exports.search = async (req, res, next) => {
  try {
    ...
    const results = await DiscogService.search(q, page)
...
exports.getReleaseDetails = async (req, res, next) => {
  try {
    const { id } = req.params
    const releaseDetails = await DiscogService.getReleaseDetails(id)
...
exports.getMasterDetails = async (req, res, next) => {
  try {
    const { id } = req.params
    let masterDetails = await DiscogService.getMasterDetails(id)
...
exports.getArtistDetails = async (req, res, next) => {
  try {
    const { id } = req.params
    let artist = await DiscogService.getArtist(id)
...
exports.getFolder = async (req, res, next) => {
  try {
    const folder = await DiscogService.getFolder(
      req.session.discogsAccount,
      req.params.id
    )
